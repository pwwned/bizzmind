...
export const dict = {
  bg: {
    ...
    pres_cost_split: "≈{brief} кр за написването (по реален разход) + {render} кр за изработката",
  ...
  en: {
    ...
    pres_cost_split: "≈{brief} cr for the writing (billed on actual use) + {render} cr to produce it",
