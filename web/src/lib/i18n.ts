...
export const dict = {
  bg: {
    ...
    theme_none: "Без избор — темата по подразбиране на workspace-а. Подредени по близост до бранда.", theme_custom_tag: "СВОЯ",
    g_text: "Текст", g_images: "Картинки", g_cards: "Слайдове", g_cards_ph: "авто", g_dims: "Пропорции", g_format: "Файл", g_lang: "Език",
    g_extra: "Насоки към Gamma", g_extra_ph: "AI-ят ги попълва сам от проекта; редактирай, ако искаш друго",
    g_extra_hint: "Попълнени автоматично от целта на анализа, бранд бука и графиките.",
    writing_deck: "Пиша презентацията", rendering_sending: "Рендирам графиките и изпращам към Gamma…",
    gamma_building: "Gamma строи презентацията… {s}с (обикновено 1–3 мин)",
    gamma_timeout: "Gamma не отговори в рамките на 8 минути.", gamma_error: "Gamma върна грешка.",
    done_in: "Готово за {s}с.", open_in_gamma: "Отвори в Gamma", editable: "(редактируема)", download_fmt: "Свали {fmt}",
    credits_line: "Кредити: −{used}, остават {left}",
    generate: "Генерирай", generating: "Генерирам…", generate_again: "Генерирай отново",
    generation_failed: "Генерирането се провали: {msg}",
    gamma_not_configured: "Презентациите не са конфигурирани (липсва Gamma API ключ).",
  ...
  en: {
    ...
    theme_none: "No selection — the workspace default theme. Sorted by closeness to the brand.", theme_custom_tag: "CUSTOM",
    g_text: "Text", g_images: "Images", g_cards: "Slides", g_cards_ph: "auto", g_dims: "Aspect", g_format: "File", g_lang: "Language",
    g_extra: "Instructions for Gamma", g_extra_ph: "The AI fills these in from the project; edit if you want something else",
    g_extra_hint: "Filled in automatically from the analysis goal, the brand book and the charts.",
    writing_deck: "Writing the presentation", rendering_sending: "Rendering charts and sending to Gamma…",
    gamma_building: "Gamma is building the presentation… {s}s (usually 1–3 min)",
    gamma_timeout: "Gamma did not respond within 8 minutes.", gamma_error: "Gamma returned an error.",
    done_in: "Done in {s}s.", open_in_gamma: "Open in Gamma", editable: "(editable)", download_fmt: "Download {fmt}",
    credits_line: "Credits: −{used}, {left} remaining",
    generate: "Generate", generating: "Generating…", generate_again: "Generate again",
    generation_failed: "Generation failed: {msg}",
    gamma_not_configured: "Presentations are not configured (missing Gamma API key).",
    lang_bg: "BG", lang_en: "EN",
  },
} as const;
