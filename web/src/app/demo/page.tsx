  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-40 border-b border-border bg-background/70 backdrop-blur-md">
        <div className={`mx-auto flex w-full items-center gap-4 px-6 py-3 ${phase === "dashboard" ? "max-w-[1500px]" : "max-w-6xl"}`}>
      ...
      <main className={`mx-auto w-full flex-1 px-6 py-10 ${phase === "dashboard" ? "max-w-[1500px]" : "max-w-5xl"}`}>
        {phase === "intro" && (
        ...
        {phase === "dashboard" && (
          <div className="page-enter">
            ...
            <div className={`mt-4 grid gap-4 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 ${refresh.isFetching ? "opacity-70 transition-opacity" : ""}`}>
