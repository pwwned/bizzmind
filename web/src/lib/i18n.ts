...
export const dict = {
  bg: {
    ...
    drag_reorder: "Влачи, за да пренаредиш", order_saved: "Подредбата е запазена.",
    ...
    cost_warn: "Това ще изгори голяма част от оставащите ти кредити. Плащаш точно колкото се изхарчи.",
    ...
    quote_short: "Няма да стигнат: очаквам около {n} кредита, а имаш {left}.",
  ...
  en: {
    ...
    drag_reorder: "Drag to reorder", order_saved: "Order saved.",
    ...
    cost_warn: "This will burn a large share of your remaining credits. You pay exactly what gets used.",
    ...
    quote_short: "Not enough: this needs around {n} credits and you have {left}.",
