...
export const dict = {
  bg: {
    ...
    upload_done: "Готово — заредени са {n} таблици.", confirm_delete_project: "Да изтрия ли проекта „{name}“ с всичките му данни?",
  ...
  en: {
    ...
    upload_done: "Done — {n} tables loaded.", confirm_delete_project: "Delete project \"{name}\" with all its data?",
