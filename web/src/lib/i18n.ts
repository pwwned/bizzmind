...
export const dict = {
  bg: {
    ...
    account_settings: "Акаунт и настройки", usage_billing: "Кредити и план",
    ...
    kind_analysis: "Анализи", kind_chat: "Въпроси и графики", kind_presentation: "Презентации",
    ...
    trial_note: "Всички платени планове са със 7-дневен безплатен тест.",
  ...
  en: {
    ...
    account_settings: "Account & settings", usage_billing: "Credits & plan",
    ...
    kind_analysis: "Analyses", kind_chat: "Questions & charts", kind_presentation: "Presentations",
    ...
    trial_note: "All paid plans come with a 7-day free trial.",
